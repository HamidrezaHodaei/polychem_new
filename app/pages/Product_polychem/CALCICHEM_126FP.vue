<template>
  ...
  @click.prevent="openPdf('/CALCICHEM 126 FP.pdf')"
>
  <span class="relative z-10">Download Data Sheet</span>
              ...
              <div class="hero-right">
                <div class="hero-right-image">
                  <img src="/calcum-126.webp" alt="Hero image" />
                </div>
              </div>
            </div>
        ...
        <tbody>
            ...
            <div id="ADVANTAGE" class="details-section">
              <div class="details-content">
                ...
                <ul class="advantage-list">
                  ...
                  <li>Low water carrying</li>
                  <li>Thermal conductivity improvement</li>
                  <li>Increase of the anti-blocking effect</li>
                  <li>Print improvement on the end product</li>
                  <li>Stable performance of the product in the production process</li>
                  <li>Ensuring high loading capability for raffia production</li>
                  <li>The relatively best price-to-performance ratio</li>
                </ul>
              </div>
              ...
              <div class="details-right">
                ...
                <div class="sidebar-box">
                  ...
                  <ul class="industry-list">
                    <li><span class="arrow">→</span> Plastics & Polymers</li>
                    <li><span class="arrow">→</span> Blown Film Production</li>
                    <li><span class="arrow">→</span> Injection Molding</li>
                    <li><span class="arrow">→</span> Packaging Industry</li>
                    <li><span class="arrow">→</span> Consumer Goods</li>
                    <li><span class="arrow">→</span> Industrial Applications</li>
                    <li><span class="arrow">→</span> Cost Optimization</li>
                      </ul>
                </div>
          ...
          <section id="PACKAGING" class="content-block-packaging">
            <div class="content-inner">
              ...
              <p class="section-text-packaging">CALCICHEM 126 FP is supplied in standard pellet form packed in 25 kg bags.</p>
            </div>
          </section>
