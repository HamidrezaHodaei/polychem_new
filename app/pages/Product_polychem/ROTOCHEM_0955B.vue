<template>
  ...
  @click.prevent="openPdf('/0966B EN.pdf')"
>
  <span class="relative z-10">Download Data Sheet</span>
              ...
              <div class="hero-right">
                <div class="hero-right-image">
                  <img src="/955B.webp" alt="Hero image" />
                </div>
              </div>
            </div>
              ...
              <div class="details-right">
                ...
                <div class="sidebar-box">
                  ...
                  <ul class="industry-list">
                    ...
                    <li><span class="arrow">→</span> Water Storage & Tanks</li>
                    <li><span class="arrow">→</span> Large Volume Containers</li>
                    <li><span class="arrow">→</span> Automotive Components</li>
                    <li><span class="arrow">→</span> Recreation & Sporting Goods</li>
                      </ul>
                </div>
